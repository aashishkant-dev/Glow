...
namespace margelo::nitro::glowfacelandmarker {
   ...
   */
  struct DetectedFaceBounds final {
  public:
  ...
  public:
    DetectedFaceBounds() = default;
    explicit DetectedFaceBounds(double x, double y, double width, double height): x(x), y(y), width(width), height(height) {}
...
namespace margelo::nitro {
  ...
  template <>
  struct JSIConverter<margelo::nitro::glowfacelandmarker::DetectedFaceBounds> final {
    static inline margelo::nitro::glowfacelandmarker::DetectedFaceBounds fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::glowfacelandmarker::DetectedFaceBounds(
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::glowfacelandmarker::DetectedFaceBounds& arg) {
